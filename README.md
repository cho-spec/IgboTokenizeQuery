This is an Information Storage and Retrieval (ISR) and Natural Language Processing (NLP) academic project for a Low-Level Resource (LLR) language using Hugging Face Transformers.
